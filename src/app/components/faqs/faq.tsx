const faqs = [
  ...
  question: 'How?',
  answer:
      'My part of the project was to design and create the user interface. I did most of the frontend including also functions to send and receive items, and for multiple languages.',
  },
